...
const sections = [
  {
    ...
    content: `Welcome to the FamousAfrica App. Your privacy is important to us. This Privacy Policy explains how we collect, use, disclose, and protect your personal information when you use our application and related services.`
  },
  {
    title: "2. Definitions",
    content: [
      { term: "SERVICE", definition: "means the website or app operated by FamousAfrica." },
  ...
  {
    title: "5. Use of Data",
    content: "FamousAfrica uses the collected data for various purposes, such as to provide and maintain our Service and to notify you about changes to it."
  },
  {
  ...
  },
  {
    ...
    content: `If you have any questions about this Privacy Policy, please contact us by email:
      ...
      famousafrica2@gmail.com

      Phone: +234 802 785 9684`
  }
]
